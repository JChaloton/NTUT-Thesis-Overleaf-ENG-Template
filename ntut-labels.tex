...
\newcommand\cTitle{國立臺北科技大學論文英文範本}
...
\newcommand\deptCname{自動化科技研究所}

% 學位名 (中文)
% Degree Name（Chinese(For Master Thesis)
...
\newcommand\eTitle{Thesis's English Template for NTUT}

% 我的姓名（英文）
% My Name（English）
\newcommand\myEname{John Doe}
...
\newcommand\advisorEname{John Doe, Ph.D.}
...
\newcommand\fulldeptEname{Graduate Institute of Automation Technology}
...
% \newcommand\degreeEname{Ph. D} for Ph. d
